...
_sceneName   = "iCal"      -- Set to scene/script name
...
--- v 1.2 whole-day events are defined by date only
      ...
      local hour,min,sec=rest:match("T(%d%d)(%d%d)(%d%d)")
      ...
      HC:request(url,{ 
          ...
          success = function(response) 
            ...
            elseif response.status==200 then
              ...
              print("HTTP Error:"..json.encode(response))
            end
          end,
