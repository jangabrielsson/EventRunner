...
--  preC['>>'] = function(k,e) return self.precompile({'and',e[2],{'always',e[3]}}) end -- test >> expr |||| test >> expr ||| t >> expr
  ...
  preC['*'] = function(k,e) return tonumber(e[2]) and tonumber(e[3]) and tonumber(e[2])*tonumber(e[3]) or e end
  preC['/'] = function(k,e) return tonumber(e[2]) and tonumber(e[3]) and tonumber(e[2])/tonumber(e[3]) or e end
--  (set (var NAME) expr) (send :val NAME expr) (var a)
--  (set (glob NAME) expr) (send :val NAME expr) (glob a)
--  (set (prop id NAME) expr) (send :NAME id expr) (prop a)
--  (set (label id name) expr) (send :set label expr) (label a)
--  (set (aref tab idx) expr) (send :set aref expr) (aref a)
